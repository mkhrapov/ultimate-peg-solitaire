//
//  SetInitialPositionView.swift
//  UltimatePegSolitaire
//
//  Created by Maksim Khrapov on 11/24/19.
...
class SetInitialPositionView: UIView {
    ...
    final class Draw {
        ...
        func drawPositions() {
            guard let solvable = GlobalStateManager.shared.solvable else {
                return
            }
                ...
                for y in 0..<Y {
                    if board.isAllowed(x, y) {
                        ...
                        if solvable[i] {
                            ...
                            if  let initX = GlobalStateManager.shared.initX,
                                let initY = GlobalStateManager.shared.initY,
                                x == initX && y == initY
                            {
