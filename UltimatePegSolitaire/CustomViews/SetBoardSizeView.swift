//
//  SetBoardSizeView.swift
//  UltimatePegSolitaire
//
//  Created by Maksim Khrapov on 11/19/19.
...
final class SetBoardSizeView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let draw = Draw(context, bounds, rows, columns)
        draw.draw()
    }
    ...
    final class Draw {
        ...
        init(_ c: CGContext, _ r: CGRect, _ y: Int, _ x: Int) {
            context = c
            rect = r
            myColors = MyColors()
            X = x
